...
%         options = optimoptions('fmincon','SpecifyObjectiveGradient',true);
        ...
        Fx = @(k) DifferentialEntropy_QuadHPT(mu_theta, cov_theta, d_theta, d_z, cov_z, N_in(idx_n_in), N_out(idx_n_out), k, N_trials, problem, myidx, auxvariable,Nspecies,Ntime, fixed_design);
